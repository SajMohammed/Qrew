...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  // Following the OS means following it as it changes, not just at first paint.
  useEffect(() => {
  ...
  // The control is a two-state switch: whatever is on screen now, give me the other one.
